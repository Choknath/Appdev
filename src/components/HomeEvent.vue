                ...
                <div class="col-lg-10">
                    ...
                    <div class="header-content text-center">
                        ...
                        <h3 class="sub-title">Please, purchase full version to get all sections, features and permission to remove credits</h3>
                            ...
                            <a class="main-btn main-btn-2" href="https://rebrand.ly/eventify-gg" rel="nofollow">Register Now</a>
        ...
        <div class="row align-items-center">
            <div class="col-lg-6">
                <div class="about-image mt-50 wow fadeInLeft" data-wow-duration="1s">
                    <img :src="require('@/assets/asset/images/about.png')" alt="About">
                </div> <!-- about image -->
            </div>
            <div class="col-lg-6">
...
<!--====== CONTACT PART ENDS ======-->
  ...
  @import'../assets/asset/css/animate.css';
  @import'../assets/asset/css/bootstrap.min.css';
  @import'../assets/asset/css/default.css';
  @import'../assets/asset/css/flaticon.css';
